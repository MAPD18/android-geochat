...
public interface Constants {
    ...
    String TAG_BASE = "geochat";
    String CHANNEL_ID = "geochat_channel";
    String CHANNEL_NAME = "Geochat Name";
    String CHANNEL_DESCRIPTION = "Notification for chat messages on app GeoChat";

    // preferences
    String PREF_KEY_USER_NAME ="key_user_name";
    String PREF_KEY_SERVER_URI ="key_server_uri";
    String PREF_KEY_SESSION_COUNTER ="key_session_counter";
    ...
    String BROADCAST_REACHED_MESSAGE_LIMIT = BASE + "REACHED_MESSAGE_LIMIT";
